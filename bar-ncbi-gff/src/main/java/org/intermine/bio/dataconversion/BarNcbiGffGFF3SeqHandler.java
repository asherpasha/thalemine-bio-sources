 ...
 * So this is mostly from intermine/intermine repository. 
 * I make some basic changes to work Arabidopsis data.
 *
 * @author Julie
 * @author Asher
 */
public class BarNcbiGffGFF3SeqHandler extends GFF3SeqHandler
{
    protected static final Logger LOG = Logger.getLogger(BarNcbiGffGFF3SeqHandler.class);
     ...
     */
    public BarNcbiGffGFF3SeqHandler() {
        // nothing
    }
    
    // Asher: Only the following is changed so far.
    static {

        CHROMOSOMES.put("NC_003070.9", "Chr1");
        CHROMOSOMES.put("NC_003071.7", "Chr2");
        CHROMOSOMES.put("NC_003074.8", "Chr3");
        CHROMOSOMES.put("NC_003075.7", "Chr4");
        CHROMOSOMES.put("NC_003076.8", "Chr5");
        CHROMOSOMES.put("NC_037304.1", "ChrM");
        CHROMOSOMES.put("NC_000932.1", "ChrC");

	/* Asher Origial intermine code
