...
public class BarTairFunctionalDescriptionsConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    BarTairFunctionalDescriptionsConverter converter;
    MockItemWriter itemWriter;

    public BarTairFunctionalDescriptionsConverterTest(String arg) {
        super(arg);
    }
